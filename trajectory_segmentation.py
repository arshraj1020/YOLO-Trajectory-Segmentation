...
def render_live_graph(smooth_points, boundaries, start_point):
    ...
    ax.set_xlabel(X_LABEL_TEXT, fontsize=9, fontweight="bold", labelpad=8)
    ax.set_ylabel(Y_LABEL_TEXT, fontsize=9, fontweight="bold", labelpad=8)
...
def save_final_graph(smooth_points, boundaries, start_point):
    ...
    # ── Axis labels (bold, as in reference) ─────────────────────────────────
